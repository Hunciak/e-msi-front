...
export const Contractors = () => {
    ...
    const sendContractor = async (e) => {
        e.preventDefault();
        try {
            const res = await fetch(`https://e-msi-back-mikym.me/contractors`, {
              method: 'POST',
    ...
    const deleteContractor = async (e, key) => {
        e.preventDefault();
        const res = await fetch(`https://e-msi-back-mikym.me/contractors/delete?id=${key}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    const editContractor = async (e, id) => {
        e.preventDefault();
        const res = await fetch(`https://e-msi-back-mikym.me/contractors/edit`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
