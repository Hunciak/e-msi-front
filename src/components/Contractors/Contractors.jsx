...
export const Contractors = () => {
    ...
    const sendContractor = async (e) => {
        e.preventDefault();
        try {
            const res = await fetch(`http://141.95.67.150:3001/contractors`, {
              method: 'POST',
    ...
    const deleteContractor = async (e, key) => {
        e.preventDefault();
        const res = await fetch(`http://141.95.67.150:3001/contractors/delete?id=${key}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    const editContractor = async (e, id) => {
        e.preventDefault();
        const res = await fetch(`http://141.95.67.150:3001/contractors/edit`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
